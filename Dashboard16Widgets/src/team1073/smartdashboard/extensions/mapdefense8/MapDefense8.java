 ...
 * **HEADER**
 */
package team1073.smartdashboard.extensions.mapdefense8;
...
public class MapDefense8 extends StaticWidget {
    
    //cd C:\Program Files\SmartDashboard
    //java -jar SmartDashboard.jar
    
    public static final DataType[] TYPES = {DataType.NUMBER};
    public static final String NAME = "MapDefense8";
    private int value = -1;
    public final MultiProperty mode = new MultiProperty(this, "MapDefense8");
