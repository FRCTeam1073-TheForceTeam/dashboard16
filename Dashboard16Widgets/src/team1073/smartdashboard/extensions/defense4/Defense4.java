 ...
 */
package team1073.smartdashboard.extensions.defense4;
 ...
 * @author julia
 */
public class Defense4 extends StaticWidget {
    
    public static final DataType[] TYPES = {DataType.NUMBER};
    public static final String NAME = "Defense4";
    private int value = -1;
    public final MultiProperty mode = new MultiProperty(this, "Defense 4");
    ...
    protected void paintComponent(Graphics g) {
        ...
        defense4 = (String)pickDefense.getSelectedItem();
