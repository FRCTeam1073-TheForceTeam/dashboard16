 ...
 * **HEADER**
 */
package team1073.smartdashboard.extensions.laucherprime;
...
public class LauchPrime extends StaticWidget {
    
    //cd C:\Program Files\SmartDashboard
    //java -jar SmartDashboard.jar
    
    public static final DataType[] TYPES = {DataType.NUMBER};
    public static final String NAME = "LauchPrime";
    private int value = -1;
    public final MultiProperty mode = new MultiProperty(this, "LauchPrime");
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawString("Laucher Prime:  " + isPrime, 0, size.height - 1);
