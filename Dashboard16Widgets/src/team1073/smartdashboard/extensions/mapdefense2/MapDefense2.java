 ...
 * **HEADER**
 */
package team1073.smartdashboard.extensions.mapdefense2;
...
public class MapDefense2 extends StaticWidget {
    
    //cd C:\Program Files\SmartDashboard
    //java -jar SmartDashboard.jar
    
    public static final DataType[] TYPES = {DataType.NUMBER};
    public static final String NAME = "MapDefense2";
    private int value = -1;
    public final MultiProperty mode = new MultiProperty(this, "MapDefense2");
