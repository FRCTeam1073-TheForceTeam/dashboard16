 ...
 * **HEADER**
 */
package team1073.smartdashboard.extensions.mapdefense6;
...
public class MapDefense6 extends StaticWidget {
    
    //cd C:\Program Files\SmartDashboard
    //java -jar SmartDashboard.jar
    
    public static final DataType[] TYPES = {DataType.NUMBER};
    public static final String NAME = "MapDefense6";
    private int value = -1;
    public final MultiProperty mode = new MultiProperty(this, "MapDefense6");
