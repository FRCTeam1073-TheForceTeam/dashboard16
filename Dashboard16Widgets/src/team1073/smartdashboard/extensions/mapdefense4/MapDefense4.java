 ...
 * **HEADER**
 */
package team1073.smartdashboard.extensions.mapdefense4;
...
public class MapDefense4 extends StaticWidget {
    
    //cd C:\Program Files\SmartDashboard
    //java -jar SmartDashboard.jar
    
    public static final DataType[] TYPES = {DataType.NUMBER};
    public static final String NAME = "MapDefense4";
    private int value = -1;
    public final MultiProperty mode = new MultiProperty(this, "MapDefense4");
