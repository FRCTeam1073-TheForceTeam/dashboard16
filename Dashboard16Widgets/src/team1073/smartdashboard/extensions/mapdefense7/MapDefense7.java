 ...
 * **HEADER**
 */
package team1073.smartdashboard.extensions.mapdefense7;
...
public class MapDefense7 extends StaticWidget {
    
    //cd C:\Program Files\SmartDashboard
    //java -jar SmartDashboard.jar
    
    public static final DataType[] TYPES = {DataType.NUMBER};
    public static final String NAME = "MapDefense7";
    private int value = -1;
    public final MultiProperty mode = new MultiProperty(this, "MapDefense7");
