 ...
 * **HEADER**
 */
package team1073.smartdashboard.extensions.defensemanipulatorangle;
...
public class DefenseManipulatorAngle extends StaticWidget {
    ...
    public static final String NAME = "Defense Manipulator";
    private int value = -1;
    public final MultiProperty mode = new MultiProperty(this, "Defense Manipulator");
    double defAngle = 45.0;
    
    public DefenseManipulatorAngle() {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawString("Defense Manipulator Angle:  " + defAngle, 0, size.height - 1);
